...
from descriptor_v2 import FrequencyDegradationTarget, DegradationDescriptorNet
...
# 상위 폴더 정의
HR_ROOT = Path(r"D:\LAB\datasets\project_use\CamVid_12_2Fold_v4\A_set")
LR_ROOT = Path(r"D:\LAB\datasets\project_use\CamVid_12_2Fold_LR_x4_Bilinear\A_set")
...
SAVE_PATH: Path = Path(r"D:\LAB\result_files\des_wavelet_module_Aset\descriptor_net.pth")
