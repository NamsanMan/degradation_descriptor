...
from descriptor_v3 import DegradationDescriptorNet, FrequencyDegradationTarget
...
CKPT_PATH = Path(r"D:\LAB\result_files\des_SWT_module_Bset\descriptor_net.pth")
...
# 결과 저장 경로
OUT_DIR = Path(r"D:\LAB\result_files\des_SWT_module_Bset\test_evaluation_vis")
...
def main():
    ...
    print("\n" + "=" * 40)
    print("   FINAL TEST EVALUATION REPORT (V3)   ")
    print("=" * 40)
